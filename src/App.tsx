    ...
    <>
      <div className='bg-center bg-cover min-h-screen font-patrick-hand backdrop-opacity-20 bg-gradient-to-b from-pink-400 to-purple-600 flex relative'>
        ...
        <div className='flex justify-center flex-col items-center relative z-10 p-10 space-y-12'>
          <h1 className='text-5xl lg:text-8xl font-semibold #B51A3Amb-8 leading-tight font-cursive animate-pulse'>
            Happy Valentine's Day!
          </h1>

          <p className='text-5xl text-gray-700 rounded-full py-3 px-6 w-11/12 md:w-2/3 lg:w-1/2'>
          ...
          <button>
            {' '}
            <button className='inline-flex items-center px-8 py-3 gap-2 border border-transparent text-base font-medium rounded-full shadow-sm text-white bg-gradient-to-r from-pink-500 to-red-500 animate-bounce '>
